...
namespace DX
{
	...
	class DeviceResources : public Utility::SingletonBase<DeviceResources>
	{
	public:
		friend class Utility::SingletonBase<DeviceResources>;
	public:
		...
		DirectX::CommonStates*  GetCommonStates() const { return m_states.get(); }
